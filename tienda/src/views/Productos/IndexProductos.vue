                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-6">
                            <div class="product">
                                    ...
                                    <div class="product-hover-overlay"><a class="product-hover-overlay-link"
                                        ...
                                        <div class="product-hover-overlay-buttons"><a
                                                ...
                                                class="btn btn-dark btn-buy" href="detail.html"><i
                                                    ...
                                                    class="btn-buy-label ms-2">View</span></a><a
                                ...
                                <div class="py-2">
                                    ...
                                    <h3 class="h6 text-uppercase mb-1"><a class="text-dark" href="detail.html">White
                                            Tee</a></h3><span class="text-muted">$40.00</span>
                                </div>
                            </div>
                        </div>
                        <!-- /product-->
                            ...
                            <div class="product">
                                ...
                                <div class="py-2">
                                    ...
                                    <h3 class="h6 text-uppercase mb-1"><a class="text-dark"
                                            href="detail.html">Carrot-fit jeans</a></h3><span
                        ...
                        <div class="col-xl-4 col-6">
                            <div class="product">
                                ...
                                <div class="py-2">
                                    ...
                                    <h3 class="h6 text-uppercase mb-1"><a class="text-dark" href="detail.html">Short
                                            top</a></h3><span class="text-muted">$40.00</span>
                                </div>
                            </div>
                        </div>
                        <!-- /product-->
                        ...
                        <div class="col-xl-4 col-6">
                            <div class="product">
                                ...
                                <div class="py-2">
                                    ...
                                    <h3 class="h6 text-uppercase mb-1"><a class="text-dark" href="detail.html">Ethnic
                        ...
                        <div class="col-xl-4 col-6">
                            <div class="product">
                                ...
                                <div class="py-2">
                                    ...
                                    <h3 class="h6 text-uppercase mb-1"><a class="text-dark" href="detail.html">Beige</a>
                        ...
                        <div class="col-xl-4 col-6">
                            <div class="product">
                                ...
                                <div class="py-2">
                                    ...
                                    <h3 class="h6 text-uppercase mb-1"><a class="text-dark" href="detail.html">Skull
                                            Tee</a></h3><span class="text-muted">$40.00</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-6">
                            <div class="product">
                                ...
                                <div class="py-2">
                                    <p class="text-muted text-sm mb-1">Denim</p>
                                    <h3 class="h6 text-uppercase mb-1"><a class="text-dark" href="detail.html">Trucker
                                            jacket</a></h3><span class="text-muted">$40.00</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-6">
                            <div class="product">
                                ...
                                <div class="py-2">
                                    <p class="text-muted text-sm mb-1">Denim</p>
                                    <h3 class="h6 text-uppercase mb-1"><a class="text-dark"
                                            href="detail.html">Blouse</a></h3><span class="text-muted">$40.00</span>
                                </div>
                            </div>
                        </div>
                        <!-- /product-->
                        ...
                        <div class="col-xl-4 col-6">
                            <div class="product">
                                ...
                                <div class="py-2">
                                    <p class="text-muted text-sm mb-1">Denim</p>
                                    <h3 class="h6 text-uppercase mb-1"><a class="text-dark" href="detail.html">Shirt</a>
                                    </h3><span class="text-muted">$40.00</span>
                                </div>
                            </div>
                        </div>
